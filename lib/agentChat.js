...
class AgentChat extends aiEngine{
    constructor(session, chatURL) {
        console.log("AgentChat constructor called");
...
//checks if escalation is required or can be handled by bot
    ...
    textProcessor(ev){
        ...
        this.interactionHandler(ev,(escalationIndicator,err)=>{
            if(err){
                    ...
                    this.skillAvailability((skills,err)=>{
                        if(err!=null){
                            ...
                            if(typeof skills[0] != 'undefined'){
                                ...
                                this.sendLine("NO AGENTS ONLINE","text");
                            }
                        }
                    })
                }else{
                    this.connector(ev.text,(data,err)=>{
                        if(err==null){
                            ...
                            console.log("ERROR IN AI ENINE CONNECTOR");
                        }
                    })
